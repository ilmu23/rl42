...
#define TI42_ABS_NUM	0xFFFFFFFF
...
#define TI42_NUMERIC_CAPS	ti42_OTkn
// string capability count
#define TI42_STRING_CAPS	ti42_slength
 ...
 * TL42_NOT_BOOL if name was not a valid capability name
 */
 ...
 * TL42_ABS_NUM if the capability is absent or cancelled,
 * TL42_NOT_NUM if name was not a valid capability name
 */
 ...
 * TL42_ABS_STR if the capability is absent or cancelled,
 * TL42_NOT_STR if name was not a valid capability name
 */
